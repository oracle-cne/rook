...
make VERSION=1.18.2 GO_BUILDFLAGS="-trimpath=false" GO_LDFLAGS="-X main.version=1.18.2" BUILD_CONTAINER_IMAGE=false TEMP=`pwd`/_output/templates build
...
%changelog
* Sat Sep 20 2025 Olcne-Builder Jenkins <olcne-builder_us@oracle.com> - 1.18.2-1
- Added Oracle specific files for 1.18.2-1
