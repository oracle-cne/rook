...
make VERSION=1.18.10 GO_BUILDFLAGS="-trimpath=false" GO_LDFLAGS="-X main.version=1.18.10" BUILD_CONTAINER_IMAGE=false TEMP=`pwd`/_output/templates build
...
%changelog
* Wed Mar 25 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.18.10-1
- Added Oracle specific files for 1.18.10-1
