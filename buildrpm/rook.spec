...
make VERSION=1.18.6 GO_BUILDFLAGS="-trimpath=false" GO_LDFLAGS="-X main.version=1.18.6" BUILD_CONTAINER_IMAGE=false TEMP=`pwd`/_output/templates build
...
%changelog
* Wed Oct 29 2025 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.18.6-1
- Added Oracle specific files for 1.18.6-1
