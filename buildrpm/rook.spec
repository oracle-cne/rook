...
make VERSION=1.18.5 GO_BUILDFLAGS="-trimpath=false" GO_LDFLAGS="-X main.version=1.18.5" BUILD_CONTAINER_IMAGE=false TEMP=`pwd`/_output/templates build
...
%changelog
* Fri Oct 24 2025 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.18.5-1
- Added Oracle specific files for 1.18.5-1
