...
make VERSION=1.19.5 GO_BUILDFLAGS="-trimpath=false" GO_LDFLAGS="-X main.version=1.19.5" BUILD_CONTAINER_IMAGE=false TEMP=`pwd`/_output/templates build
...
%changelog
* Wed Apr 29 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.19.5-1
- Added Oracle specific files for 1.19.5-1
