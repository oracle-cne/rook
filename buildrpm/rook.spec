...
make VERSION=1.19.9 GO_BUILDFLAGS="-trimpath=false" GO_LDFLAGS="-X main.version=1.19.9" BUILD_CONTAINER_IMAGE=false TEMP=`pwd`/_output/templates build
...
%changelog
* Thu Aug 20 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.19.9-1
