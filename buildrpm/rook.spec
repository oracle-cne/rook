...
make VERSION=1.20.6 GO_BUILDFLAGS="-trimpath=false" GO_LDFLAGS="-X main.version=1.20.6" BUILD_CONTAINER_IMAGE=false TEMP=`pwd`/_output/templates build
...
%changelog
* Fri Aug 21 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.20.6-1
- Added Oracle specific files for 1.20.6-1
