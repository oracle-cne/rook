...
make VERSION=1.18.9 GO_BUILDFLAGS="-trimpath=false" GO_LDFLAGS="-X main.version=1.18.9" BUILD_CONTAINER_IMAGE=false TEMP=`pwd`/_output/templates build
...
%changelog
* Fri Jan 23 2026 Oracle Cloud Native Environment Authors <noreply@oracle.com> - 1.18.9-1
- Added Oracle specific files for 1.18.9-1
